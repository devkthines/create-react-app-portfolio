...
export declare function getPathFromRoute(route: ConfigRoute, routes: RouteManifest): string;
export declare function getRegExpFromPath(path: string): RegExp | false;
